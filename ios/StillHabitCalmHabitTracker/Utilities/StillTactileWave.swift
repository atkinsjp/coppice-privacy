...
//
//  The signature StillHabitCalmHabitTracker tactile interaction.
...
/// StillHabitCalmHabitTracker's signature fluid button style: 0.97 press-scale on a
...
extension View {
    /// Attaches the StillHabitCalmHabitTracker tactile wave to a non-Button surface.
