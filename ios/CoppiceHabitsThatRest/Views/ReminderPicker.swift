...
struct ReminderPicker: View {
    ...
    /// can tell a CoppiceHabitsThatRest nudge apart from every other alert on the phone.
    ...
    /// Shown only when the system has notifications turned off for CoppiceHabitsThatRest.
