...
nonisolated func stillhabitHandleFatalSignal(_ received: Int32) {
    ...
    stillhabitRawWrite("\n[CoppiceHabitsThatRest] FATAL signal ")
...
nonisolated final class DiagnosticsTrail: @unchecked Sendable {
    ...
    func append(_ event: String) {
        ...
        stillhabitWriteToStandardError("[CoppiceHabitsThatRest] " + stamped)
...
nonisolated enum CrashDiagnostics {
    ...
    static func install() {
        stillhabitWriteToStandardError("[CoppiceHabitsThatRest] === session start ===")

        if let previous = trail.takePreviousSession() {
            stillhabitWriteToStandardError("[CoppiceHabitsThatRest] previous session trail:\n" + previous)
        }
        ...
        NSSetUncaughtExceptionHandler { exception in
            ...
            stillhabitWriteToStandardError("[CoppiceHabitsThatRest] " + summary + "\n" + symbols)
