...
//  reminder surfaces inside the app: when it lands as a banner while CoppiceHabitsThatRest
...
nonisolated enum ReminderHaptic: String, CaseIterable, Identifiable, Sendable {
    ...
    /// habits created before this setting existed still feel like CoppiceHabitsThatRest.
